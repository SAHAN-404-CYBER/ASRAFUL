...
\33[1;37m----------------------------------------------""")
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801401648565?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
#menu_apikey()
os.system
(f'xdg-open {tan}://www.facebook.com/yt.sahan.x.ff')
logo=(f"""
...
def Sahan():
	...
	if me in ["1", "01","11","A","a"]:
		...
		try:
			...
			ps_limit =1
		print(f'\033[1;32m exp: first last,firtslast,first123 fariya123')
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        print(f'\033[92;1m>>\033[1;32m Random Version ..... ')
